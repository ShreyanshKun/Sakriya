...
export default function ProductsPage() {
  ...
  const products = useMemo(() => [
    // Squash
    { id: 1, name: "Ripe Mango – 500 ml", price: "₹80", image: "/images/products/ripe-mango-squash.jpg", description: "Refreshing ripe mango squash", category: "Squash", inStock: true, organic: true },
    { id: 2, name: "Raw Mango – 500 ml", price: "₹80", image: "/images/products/raw-mango-squash.jpg", description: "Tangy raw mango squash", category: "Squash", inStock: true, organic: true },
    { id: 3, name: "Raw Mango (Cumin) – 500 ml", price: "₹80", image: "/images/products/raw-mango-squash.jpg", description: "Raw mango squash with cumin", category: "Squash", inStock: true, organic: true },
    { id: 4, name: "Roasted Mango – 500 ml", price: "₹85", image: "/images/products/roasted-mango-squash.jpg", description: "Smoky roasted mango squash", category: "Squash", inStock: true, organic: true },
    { id: 5, name: "Lemon – 500 ml", price: "₹90", image: "/images/products/lemon-squash.jpg", description: "Classic lemon squash", category: "Squash", inStock: true, organic: true },
    ...
    { id: 10, name: "Olive – 250 g", price: "₹60", image: "/images/products/olive-pickle.jpg", description: "Olive pickle", category: "Pickles", inStock: true, organic: true },
    ...
    // Jam
    { id: 13, name: "Raw Mango – 250 g", price: "₹60", image: "/images/products/jam-new.jpg", description: "Raw mango jam", category: "Jam", inStock: true, organic: true },
    { id: 14, name: "Mixed – 250 g", price: "₹60", image: "/images/products/jam-new.jpg", description: "Mixed fruit jam", category: "Jam", inStock: true, organic: true },

    // Sauces
    { id: 15, name: "Chili Sauce – 500 ml", price: "₹80", image: "/images/products/chili-sauce.jpg", description: "Spicy chili sauce", category: "Sauces", inStock: true, organic: true },
    { id: 16, name: "Mango Kasundi – 500 ml", price: "₹80", image: "/images/products/mango-kasundi.jpg", description: "Mango mustard sauce", category: "Sauces", inStock: true, organic: true },

    // Others
    { id: 17, name: "Aam Sattva (Mango Bar) – 1 kg", price: "₹1000", image: "/images/products/aam-sattva.jpg", description: "Traditional mango bars", category: "Others", inStock: true, organic: true },
    { id: 18, name: "Turmeric Powder – 100 g", price: "₹40", image: "/images/products/turmeric.jpg", description: "Ground turmeric powder", category: "Others", inStock: true, organic: true },
    { id: 19, name: "Buckwheat", price: "₹80/kg", image: "/images/products/buckwheat.jpg", description: "Whole buckwheat", category: "Others", inStock: true, organic: true },
  ], []);
